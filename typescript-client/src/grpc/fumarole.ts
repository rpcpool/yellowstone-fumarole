...
export interface BlockFilters_TransactionsStatusEntry {
  key: string;
  value: SubscribeRequestFilterTransactions | undefined;
}
...
export const GetSlotRangeRequest: MessageFns<GetSlotRangeRequest> = {
  ...
  fromJSON(object: any): GetSlotRangeRequest {
    return {
      blockchainId: isSet(object.blockchainId)
        ? bytesFromBase64(object.blockchainId)
        : isSet(object.blockchain_id)
        ? bytesFromBase64(object.blockchain_id)
        : new Uint8Array(0),
    };
  },
  ...
  fromJSON(object: any): GetSlotRangeResponse {
    return {
      blockchainId: isSet(object.blockchainId)
        ...
        ? bytesFromBase64(object.blockchain_id)
        : new Uint8Array(0),
      minSlot: isSet(object.minSlot) ? BigInt(object.minSlot) : isSet(object.min_slot) ? BigInt(object.min_slot) : 0n,
      maxSlot: isSet(object.maxSlot) ? BigInt(object.maxSlot) : isSet(object.max_slot) ? BigInt(object.max_slot) : 0n,
    };
  },
...
export const GetChainTipResponse: MessageFns<GetChainTipResponse> = {
  encode(message: GetChainTipResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.shardToMaxOffsetMap).forEach(([key, value]: [string, bigint]) => {
  ...
  fromJSON(object: any): GetChainTipResponse {
    return {
      ...
      shardToMaxOffsetMap: isObject(object.shardToMaxOffsetMap)
        ? (globalThis.Object.entries(object.shardToMaxOffsetMap) as [string, any][]).reduce(
          (acc: { [key: number]: bigint }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = BigInt(value as string | number | bigint | boolean);
            return acc;
          },
          {},
        )
        : isObject(object.shard_to_max_offset_map)
        ? (globalThis.Object.entries(object.shard_to_max_offset_map) as [string, any][]).reduce(
          (acc: { [key: number]: bigint }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = BigInt(value as string | number | bigint | boolean);
            return acc;
          },
  ...
  toJSON(message: GetChainTipResponse): unknown {
    ...
    if (message.shardToMaxOffsetMap) {
      const entries = globalThis.Object.entries(message.shardToMaxOffsetMap) as [string, bigint][];
      if (entries.length > 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<GetChainTipResponse>, I>>(object: I): GetChainTipResponse {
    const message = createBaseGetChainTipResponse();
    message.blockchainId = object.blockchainId ?? new Uint8Array(0);
    message.shardToMaxOffsetMap = (globalThis.Object.entries(object.shardToMaxOffsetMap ?? {}) as [string, bigint][])
      .reduce((acc: { [key: number]: bigint }, [key, value]: [string, bigint]) => {
        if (value !== undefined) {
          acc[globalThis.Number(key)] = BigInt(value as string | number | bigint | boolean);
        }
        return acc;
...
export const GetConsumerGroupInfoRequest: MessageFns<GetConsumerGroupInfoRequest> = {
  ...
  fromJSON(object: any): GetConsumerGroupInfoRequest {
    return {
      consumerGroupName: isSet(object.consumerGroupName)
        ? globalThis.String(object.consumerGroupName)
        : isSet(object.consumer_group_name)
        ? globalThis.String(object.consumer_group_name)
        : "",
    };
  },
  ...
  fromJSON(object: any): ListConsumerGroupsResponse {
    return {
      consumerGroups: globalThis.Array.isArray(object?.consumerGroups)
        ...
        : globalThis.Array.isArray(object?.consumer_groups)
        ? object.consumer_groups.map((e: any) => ConsumerGroupInfo.fromJSON(e))
        : [],
    };
  },
...
export const BlockFilters: MessageFns<BlockFilters> = {
  encode(message: BlockFilters, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.entries).forEach(([key, value]: [string, SubscribeRequestFilterEntry]) => {
  ...
  toJSON(message: BlockFilters): unknown {
    ...
    if (message.entries) {
      const entries = globalThis.Object.entries(message.entries) as [string, SubscribeRequestFilterEntry][];
      if (entries.length > 0) {
        obj.entries = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<BlockFilters>, I>>(object: I): BlockFilters {
    ...
    message.entries = (globalThis.Object.entries(object.entries ?? {}) as [string, SubscribeRequestFilterEntry][])
      .reduce(
...
function createBaseBlockFilters_TransactionsStatusEntry(): BlockFilters_TransactionsStatusEntry {
  return { key: "", value: undefined };
}

export const BlockFilters_TransactionsStatusEntry: MessageFns<BlockFilters_TransactionsStatusEntry> = {
  encode(message: BlockFilters_TransactionsStatusEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BlockFilters_TransactionsStatusEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseBlockFilters_TransactionsStatusEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): BlockFilters_TransactionsStatusEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? SubscribeRequestFilterTransactions.fromJSON(object.value) : undefined,
    };
  ...
  toJSON(message: BlockFilters_TransactionsStatusEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create<I extends Exact<DeepPartial<BlockFilters_TransactionsStatusEntry>, I>>(
    base?: I,
  ): BlockFilters_TransactionsStatusEntry {
    return BlockFilters_TransactionsStatusEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BlockFilters_TransactionsStatusEntry>, I>>(
    object: I,
  ): BlockFilters_TransactionsStatusEntry {
    const message = createBaseBlockFilters_TransactionsStatusEntry();
    message.key = object.key ?? "";
  ...
  fromJSON(object: any): DownloadBlockShard {
    return {
      blockchainId: isSet(object.blockchainId)
        ...
        ? bytesFromBase64(object.blockchain_id)
        : new Uint8Array(0),
      blockUid: isSet(object.blockUid)
        ? bytesFromBase64(object.blockUid)
        : isSet(object.block_uid)
        ? bytesFromBase64(object.block_uid)
        : new Uint8Array(0),
      shardIdx: isSet(object.shardIdx)
        ? globalThis.Number(object.shardIdx)
        : isSet(object.shard_idx)
        ? globalThis.Number(object.shard_idx)
        : 0,
  ...
  fromJSON(object: any): Ping {
    return {
      pingId: isSet(object.pingId)
        ...
        : isSet(object.ping_id)
        ? globalThis.Number(object.ping_id)
        : 0,
    };
  },
  ...
  fromJSON(object: any): DataCommand {
    return {
      downloadBlockShard: isSet(object.downloadBlockShard)
        ...
        : isSet(object.download_block_shard)
        ? DownloadBlockShard.fromJSON(object.download_block_shard)
        : undefined,
      filterUpdate: isSet(object.filterUpdate)
        ? BlockFilters.fromJSON(object.filterUpdate)
        : isSet(object.filter_update)
        ? BlockFilters.fromJSON(object.filter_update)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): BlockShardDownloadFinish {
    return {
      ...
      shardIndices: globalThis.Array.isArray(object?.shardIndices)
        ...
        : globalThis.Array.isArray(object?.shard_indices)
        ? object.shard_indices.map((e: any) => globalThis.Number(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): DataError {
    return {
      notFound: isSet(object.notFound)
        ? BlockNotFound.fromJSON(object.notFound)
        : isSet(object.not_found)
        ? BlockNotFound.fromJSON(object.not_found)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): DataResponse {
    return {
      ...
      blockShardDownloadFinish: isSet(object.blockShardDownloadFinish)
        ...
        : isSet(object.block_shard_download_finish)
        ? BlockShardDownloadFinish.fromJSON(object.block_shard_download_finish)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): BlockchainEvent {
    return {
      ...
      blockUid: isSet(object.blockUid)
        ...
        ? bytesFromBase64(object.block_uid)
        : new Uint8Array(0),
      numShards: isSet(object.numShards)
        ? globalThis.Number(object.numShards)
        : isSet(object.num_shards)
        ? globalThis.Number(object.num_shards)
        : 0,
      slot: isSet(object.slot) ? BigInt(object.slot) : 0n,
      parentSlot: isSet(object.parentSlot)
        ...
        : undefined,
      commitmentLevel: isSet(object.commitmentLevel)
        ? commitmentLevelFromJSON(object.commitmentLevel)
        : isSet(object.commitment_level)
        ? commitmentLevelFromJSON(object.commitment_level)
        : 0,
      blockchainShardId: isSet(object.blockchainShardId)
        ? globalThis.Number(object.blockchainShardId)
        : isSet(object.blockchain_shard_id)
        ? globalThis.Number(object.blockchain_shard_id)
        : 0,
...
export const ControlCommand: MessageFns<ControlCommand> = {
  ...
  fromJSON(object: any): ControlCommand {
    return {
      initialJoin: isSet(object.initialJoin)
        ? JoinControlPlane.fromJSON(object.initialJoin)
        : isSet(object.initial_join)
        ? JoinControlPlane.fromJSON(object.initial_join)
        : undefined,
      commitOffset: isSet(object.commitOffset)
        ? CommitOffset.fromJSON(object.commitOffset)
        : isSet(object.commit_offset)
        ? CommitOffset.fromJSON(object.commit_offset)
        : undefined,
      pollHist: isSet(object.pollHist)
        ? PollBlockchainHistory.fromJSON(object.pollHist)
        : isSet(object.poll_hist)
        ? PollBlockchainHistory.fromJSON(object.poll_hist)
        : undefined,
...
export const ControlResponse: MessageFns<ControlResponse> = {
  ...
  fromJSON(object: any): ControlResponse {
    return {
      ...
      commitOffset: isSet(object.commitOffset)
        ? CommitOffsetResult.fromJSON(object.commitOffset)
        : isSet(object.commit_offset)
        ? CommitOffsetResult.fromJSON(object.commit_offset)
        : undefined,
      pollHist: isSet(object.pollHist)
        ? BlockchainHistory.fromJSON(object.pollHist)
        : isSet(object.poll_hist)
        ? BlockchainHistory.fromJSON(object.poll_hist)
        : undefined,
...
export const InitialConsumerGroupState: MessageFns<InitialConsumerGroupState> = {
  encode(message: InitialConsumerGroupState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.lastCommittedOffsets).forEach(([key, value]: [string, bigint]) => {
  ...
  fromJSON(object: any): InitialConsumerGroupState {
    return {
      ...
      lastCommittedOffsets: isObject(object.lastCommittedOffsets)
        ? (globalThis.Object.entries(object.lastCommittedOffsets) as [string, any][]).reduce(
          (acc: { [key: number]: bigint }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = BigInt(value as string | number | bigint | boolean);
            return acc;
          },
        ...
        : isObject(object.last_committed_offsets)
        ? (globalThis.Object.entries(object.last_committed_offsets) as [string, any][]).reduce(
          (acc: { [key: number]: bigint }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = BigInt(value as string | number | bigint | boolean);
            return acc;
          },
  ...
  toJSON(message: InitialConsumerGroupState): unknown {
    ...
    if (message.lastCommittedOffsets) {
      const entries = globalThis.Object.entries(message.lastCommittedOffsets) as [string, bigint][];
      if (entries.length > 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<InitialConsumerGroupState>, I>>(object: I): InitialConsumerGroupState {
    const message = createBaseInitialConsumerGroupState();
    message.blockchainId = object.blockchainId ?? new Uint8Array(0);
    message.lastCommittedOffsets = (globalThis.Object.entries(object.lastCommittedOffsets ?? {}) as [string, bigint][])
      .reduce((acc: { [key: number]: bigint }, [key, value]: [string, bigint]) => {
        if (value !== undefined) {
          acc[globalThis.Number(key)] = BigInt(value as string | number | bigint | boolean);
        }
...
export const CreateConsumerGroupResponse: MessageFns<CreateConsumerGroupResponse> = {
  ...
  fromJSON(object: any): CreateConsumerGroupResponse {
    return {
      consumerGroupId: isSet(object.consumerGroupId)
        ? globalThis.String(object.consumerGroupId)
        : isSet(object.consumer_group_id)
        ? globalThis.String(object.consumer_group_id)
        : "",
    };
  },
  ...
  fromJSON(object: any): CreateConsumerGroupRequest {
    return {
      ...
      initialOffsetPolicy: isSet(object.initialOffsetPolicy)
        ...
        : isSet(object.initial_offset_policy)
        ? initialOffsetPolicyFromJSON(object.initial_offset_policy)
        : 0,
