...
/**
 * WARNING: THIS FILE IS COPIED FROM THE YELLOWSTONE-GRPC GIT SUBMODULE AT WORKSPACE ROOT
 * DO NOT EDIT THIS FILE DIRECTLY. EDIT THE ORIGINAL FILE IN THE SUBMODULE AND RUN
 */
...
export function cuckooHashAlgorithmFromJSON(object: any): CuckooHashAlgorithm {
  switch (object) {
    case 0:
    case "SIP_HASH":
...
export function cuckooHashAlgorithmToJSON(object: CuckooHashAlgorithm): string {
  switch (object) {
...
export function tokenAccountExpansionControlFlagFromJSON(object: any): TokenAccountExpansionControlFlag {
  switch (object) {
    case 0:
    case "ALL":
      return TokenAccountExpansionControlFlag.ALL;
    case 1:
    case "BALANCE_CHANGED":
      return TokenAccountExpansionControlFlag.BALANCE_CHANGED;
    case -1:
    case "UNRECOGNIZED":
    default:
      return TokenAccountExpansionControlFlag.UNRECOGNIZED;
  }
}

export function tokenAccountExpansionControlFlagToJSON(object: TokenAccountExpansionControlFlag): string {
  switch (object) {
    case TokenAccountExpansionControlFlag.ALL:
      return "ALL";
    case TokenAccountExpansionControlFlag.BALANCE_CHANGED:
      return "BALANCE_CHANGED";
    case TokenAccountExpansionControlFlag.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export interface SubscribeDeshredRequest {
  deshredTransactions: { [key: string]: SubscribeRequestFilterDeshredTransactions };
  ping?: SubscribeRequestPing | undefined;
  slots: { [key: string]: SubscribeRequestFilterSlots };
}
...
export const SubscribeRequest: MessageFns<SubscribeRequest> = {
  encode(message: SubscribeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.accounts).forEach(([key, value]: [string, SubscribeRequestFilterAccounts]) => {
      SubscribeRequest_AccountsEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    globalThis.Object.entries(message.slots).forEach(([key, value]: [string, SubscribeRequestFilterSlots]) => {
      SubscribeRequest_SlotsEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).join();
    });
    globalThis.Object.entries(message.transactions).forEach(
    ...
    globalThis.Object.entries(message.blocks).forEach(([key, value]: [string, SubscribeRequestFilterBlocks]) => {
      SubscribeRequest_BlocksEntry.encode({ key: key as any, value }, writer.uint32(34).fork()).join();
    });
    globalThis.Object.entries(message.blocksMeta).forEach(
      ([key, value]: [string, SubscribeRequestFilterBlocksMeta]) => {
        SubscribeRequest_BlocksMetaEntry.encode({ key: key as any, value }, writer.uint32(42).fork()).join();
      },
    );
    globalThis.Object.entries(message.entry).forEach(([key, value]: [string, SubscribeRequestFilterEntry]) => {
    ...
    return {
      accounts: isObject(object.accounts)
        ? (globalThis.Object.entries(object.accounts) as [string, any][]).reduce(
          (acc: { [key: string]: SubscribeRequestFilterAccounts }, [key, value]: [string, any]) => {
      ...
      slots: isObject(object.slots)
        ? (globalThis.Object.entries(object.slots) as [string, any][]).reduce(
          (acc: { [key: string]: SubscribeRequestFilterSlots }, [key, value]: [string, any]) => {
      ...
      transactions: isObject(object.transactions)
        ? (globalThis.Object.entries(object.transactions) as [string, any][]).reduce(
          (acc: { [key: string]: SubscribeRequestFilterTransactions }, [key, value]: [string, any]) => {
      ...
      transactionsStatus: isObject(object.transactionsStatus)
        ? (globalThis.Object.entries(object.transactionsStatus) as [string, any][]).reduce(
          (acc: { [key: string]: SubscribeRequestFilterTransactions }, [key, value]: [string, any]) => {
            acc[key] = SubscribeRequestFilterTransactions.fromJSON(value);
            return acc;
          },
        ...
        ? (globalThis.Object.entries(object.transactions_status) as [string, any][]).reduce(
          (acc: { [key: string]: SubscribeRequestFilterTransactions }, [key, value]: [string, any]) => {
            acc[key] = SubscribeRequestFilterTransactions.fromJSON(value);
            return acc;
          },
      ...
      blocks: isObject(object.blocks)
        ? (globalThis.Object.entries(object.blocks) as [string, any][]).reduce(
          (acc: { [key: string]: SubscribeRequestFilterBlocks }, [key, value]: [string, any]) => {
      ...
      blocksMeta: isObject(object.blocksMeta)
        ? (globalThis.Object.entries(object.blocksMeta) as [string, any][]).reduce(
          (acc: { [key: string]: SubscribeRequestFilterBlocksMeta }, [key, value]: [string, any]) => {
        ...
        ? (globalThis.Object.entries(object.blocks_meta) as [string, any][]).reduce(
          (acc: { [key: string]: SubscribeRequestFilterBlocksMeta }, [key, value]: [string, any]) => {
            acc[key] = SubscribeRequestFilterBlocksMeta.fromJSON(value);
            return acc;
          },
      ...
      entry: isObject(object.entry)
        ? (globalThis.Object.entries(object.entry) as [string, any][]).reduce(
          (acc: { [key: string]: SubscribeRequestFilterEntry }, [key, value]: [string, any]) => {
  ...
  toJSON(message: SubscribeRequest): unknown {
    const obj: any = {};
    if (message.accounts) {
      const entries = globalThis.Object.entries(message.accounts) as [string, SubscribeRequestFilterAccounts][];
      if (entries.length > 0) {
        obj.accounts = {};
        entries.forEach(([k, v]) => {
    ...
    if (message.slots) {
      const entries = globalThis.Object.entries(message.slots) as [string, SubscribeRequestFilterSlots][];
      if (entries.length > 0) {
        obj.slots = {};
        entries.forEach(([k, v]) => {
    ...
    if (message.transactions) {
      const entries = globalThis.Object.entries(message.transactions) as [string, SubscribeRequestFilterTransactions][];
      if (entries.length > 0) {
        obj.transactions = {};
        entries.forEach(([k, v]) => {
    ...
    if (message.transactionsStatus) {
      const entries = globalThis.Object.entries(message.transactionsStatus) as [
        string,
    ...
    if (message.blocks) {
      const entries = globalThis.Object.entries(message.blocks) as [string, SubscribeRequestFilterBlocks][];
      if (entries.length > 0) {
        obj.blocks = {};
        entries.forEach(([k, v]) => {
    ...
    if (message.blocksMeta) {
      const entries = globalThis.Object.entries(message.blocksMeta) as [string, SubscribeRequestFilterBlocksMeta][];
      if (entries.length > 0) {
        obj.blocksMeta = {};
        entries.forEach(([k, v]) => {
    ...
    if (message.entry) {
      const entries = globalThis.Object.entries(message.entry) as [string, SubscribeRequestFilterEntry][];
      if (entries.length > 0) {
        obj.entry = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<SubscribeRequest>, I>>(object: I): SubscribeRequest {
    const message = createBaseSubscribeRequest();
    message.accounts = (globalThis.Object.entries(object.accounts ?? {}) as [string, SubscribeRequestFilterAccounts][])
      .reduce(
        (
          acc: { [key: string]: SubscribeRequestFilterAccounts },
          [key, value]: [string, SubscribeRequestFilterAccounts],
        ) => {
          if (value !== undefined) {
    ...
    message.slots = (globalThis.Object.entries(object.slots ?? {}) as [string, SubscribeRequestFilterSlots][]).reduce(
      (acc: { [key: string]: SubscribeRequestFilterSlots }, [key, value]: [string, SubscribeRequestFilterSlots]) => {
        if (value !== undefined) {
    ...
    message.transactions =
      (globalThis.Object.entries(object.transactions ?? {}) as [string, SubscribeRequestFilterTransactions][]).reduce(
        (
          acc: { [key: string]: SubscribeRequestFilterTransactions },
          [key, value]: [string, SubscribeRequestFilterTransactions],
        ) => {
          if (value !== undefined) {
    ...
    message.transactionsStatus =
      (globalThis.Object.entries(object.transactionsStatus ?? {}) as [string, SubscribeRequestFilterTransactions][])
        .reduce(
          (
            acc: { [key: string]: SubscribeRequestFilterTransactions },
            [key, value]: [string, SubscribeRequestFilterTransactions],
    ...
    message.blocks = (globalThis.Object.entries(object.blocks ?? {}) as [string, SubscribeRequestFilterBlocks][])
      .reduce(
        (
          acc: { [key: string]: SubscribeRequestFilterBlocks },
          [key, value]: [string, SubscribeRequestFilterBlocks],
        ) => {
          if (value !== undefined) {
    ...
    message.blocksMeta =
      (globalThis.Object.entries(object.blocksMeta ?? {}) as [string, SubscribeRequestFilterBlocksMeta][]).reduce(
        (
          acc: { [key: string]: SubscribeRequestFilterBlocksMeta },
          [key, value]: [string, SubscribeRequestFilterBlocksMeta],
        ) => {
          if (value !== undefined) {
    ...
    message.entry = (globalThis.Object.entries(object.entry ?? {}) as [string, SubscribeRequestFilterEntry][]).reduce(
      (acc: { [key: string]: SubscribeRequestFilterEntry }, [key, value]: [string, SubscribeRequestFilterEntry]) => {
        if (value !== undefined) {
...
function createBaseCuckooFilter(): CuckooFilter {
  return {
...
export const CuckooFilter: MessageFns<CuckooFilter> = {
  encode(message: CuckooFilter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.hashSeed !== 0n) {
      if (BigInt.asUintN(64, message.hashSeed) !== message.hashSeed) {
        throw new globalThis.Error("value provided for field message.hashSeed of type uint64 too large");
      }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CuckooFilter {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.hashSeed = reader.uint64() as bigint;
          continue;
        }
        case 6: {
          if (tag !== 48) {
  ...
  fromJSON(object: any): CuckooFilter {
    return {
      ...
      hashSeed: isSet(object.hashSeed)
        ? BigInt(object.hashSeed)
        : isSet(object.hash_seed)
        ? BigInt(object.hash_seed)
        : 0n,
  ...
  toJSON(message: CuckooFilter): unknown {
    const obj: any = {};
    if (message.data.length !== 0) {
    ...
    if (message.hashSeed !== 0n) {
      obj.hashSeed = message.hashSeed.toString();
    }
    if (message.hashAlgorithm !== 0) {
  ...
  create<I extends Exact<DeepPartial<CuckooFilter>, I>>(base?: I): CuckooFilter {
    return CuckooFilter.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CuckooFilter>, I>>(object: I): CuckooFilter {
    const message = createBaseCuckooFilter();
    ...
    message.hashSeed = object.hashSeed ?? 0n;
...
export const SubscribeRequestFilterTransactions: MessageFns<SubscribeRequestFilterTransactions> = {
  encode(message: SubscribeRequestFilterTransactions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.cuckooAccountInclude !== undefined) {
      CuckooFilter.encode(message.cuckooAccountInclude, writer.uint32(58).fork()).join();
    }
    if (message.tokenAccounts !== undefined) {
      writer.uint32(240).int32(message.tokenAccounts);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 30: {
          ...
          message.tokenAccounts = reader.int32() as any;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): SubscribeRequestFilterTransactions {
    return {
      ...
      accountInclude: globalThis.Array.isArray(object?.accountInclude)
        ...
        ? object.account_include.map((e: any) => globalThis.String(e))
        : [],
      accountExclude: globalThis.Array.isArray(object?.accountExclude)
        ...
        ? object.account_exclude.map((e: any) => globalThis.String(e))
        : [],
      ...
      cuckooAccountInclude: isSet(object.cuckooAccountInclude)
        ...
        : undefined,
      tokenAccounts: isSet(object.tokenAccounts)
        ? tokenAccountExpansionControlFlagFromJSON(object.tokenAccounts)
        : isSet(object.token_accounts)
        ? tokenAccountExpansionControlFlagFromJSON(object.token_accounts)
        : undefined,
    };
  },
  ...
  toJSON(message: SubscribeRequestFilterTransactions): unknown {
    ...
    if (message.tokenAccounts !== undefined) {
      obj.tokenAccounts = tokenAccountExpansionControlFlagToJSON(message.tokenAccounts);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<SubscribeRequestFilterTransactions>, I>>(
    ...
    message.cuckooAccountInclude = (object.cuckooAccountInclude !== undefined && object.cuckooAccountInclude !== null)
      ...
      : undefined;
    message.tokenAccounts = object.tokenAccounts ?? undefined;
    return message;
  },
};
...
export const SubscribeRequestFilterDeshredTransactions: MessageFns<SubscribeRequestFilterDeshredTransactions> = {
  encode(message: SubscribeRequestFilterDeshredTransactions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.vote !== undefined) {
      writer.uint32(8).bool(message.vote);
    }
    for (const v of message.accountInclude) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SubscribeRequestFilterDeshredTransactions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): SubscribeRequestFilterDeshredTransactions {
    return {
      vote: isSet(object.vote) ? globalThis.Boolean(object.vote) : undefined,
      accountInclude: globalThis.Array.isArray(object?.accountInclude)
        ? object.accountInclude.map((e: any) => globalThis.String(e))
  ...
  toJSON(message: SubscribeRequestFilterDeshredTransactions): unknown {
    const obj: any = {};
    if (message.vote !== undefined) {
      obj.vote = message.vote;
    }
  ...
  create<I extends Exact<DeepPartial<SubscribeRequestFilterDeshredTransactions>, I>>(
    base?: I,
  ): SubscribeRequestFilterDeshredTransactions {
    return SubscribeRequestFilterDeshredTransactions.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SubscribeRequestFilterDeshredTransactions>, I>>(
    object: I,
  ): SubscribeRequestFilterDeshredTransactions {
    const message = createBaseSubscribeRequestFilterDeshredTransactions();
    message.vote = object.vote ?? undefined;
...
function createBaseSubscribeDeshredRequest(): SubscribeDeshredRequest {
  return { deshredTransactions: {}, ping: undefined, slots: {} };
}

export const SubscribeDeshredRequest: MessageFns<SubscribeDeshredRequest> = {
  encode(message: SubscribeDeshredRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.deshredTransactions).forEach(
      ([key, value]: [string, SubscribeRequestFilterDeshredTransactions]) => {
        SubscribeDeshredRequest_DeshredTransactionsEntry.encode({ key: key as any, value }, writer.uint32(10).fork())
          .join();
      },
    );
    if (message.ping !== undefined) {
    ...
    globalThis.Object.entries(message.slots).forEach(([key, value]: [string, SubscribeRequestFilterSlots]) => {
      SubscribeDeshredRequest_SlotsEntry.encode({ key: key as any, value }, writer.uint32(26).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SubscribeDeshredRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): SubscribeDeshredRequest {
    return {
      deshredTransactions: isObject(object.deshredTransactions)
        ? (globalThis.Object.entries(object.deshredTransactions) as [string, any][]).reduce(
          (acc: { [key: string]: SubscribeRequestFilterDeshredTransactions }, [key, value]: [string, any]) => {
        ...
        ? (globalThis.Object.entries(object.deshred_transactions) as [string, any][]).reduce(
          (acc: { [key: string]: SubscribeRequestFilterDeshredTransactions }, [key, value]: [string, any]) => {
            acc[key] = SubscribeRequestFilterDeshredTransactions.fromJSON(value);
            return acc;
          },
  ...
  toJSON(message: SubscribeDeshredRequest): unknown {
    const obj: any = {};
    if (message.deshredTransactions) {
      const entries = globalThis.Object.entries(message.deshredTransactions) as [
        string,
        SubscribeRequestFilterDeshredTransactions,
      ][];
      if (entries.length > 0) {
  ...
  create<I extends Exact<DeepPartial<SubscribeDeshredRequest>, I>>(base?: I): SubscribeDeshredRequest {
    return SubscribeDeshredRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SubscribeDeshredRequest>, I>>(object: I): SubscribeDeshredRequest {
    const message = createBaseSubscribeDeshredRequest();
    message.deshredTransactions =
      (globalThis.Object.entries(object.deshredTransactions ?? {}) as [
        string,
        SubscribeRequestFilterDeshredTransactions,
      ][]).reduce(
        (
          acc: { [key: string]: SubscribeRequestFilterDeshredTransactions },
          [key, value]: [string, SubscribeRequestFilterDeshredTransactions],
        ) => {
          if (value !== undefined) {
...
function createBaseSubscribeDeshredRequest_DeshredTransactionsEntry(): SubscribeDeshredRequest_DeshredTransactionsEntry {
  return { key: "", value: undefined };
}

export const SubscribeDeshredRequest_DeshredTransactionsEntry: MessageFns<
  SubscribeDeshredRequest_DeshredTransactionsEntry
> = {
  encode(
    message: SubscribeDeshredRequest_DeshredTransactionsEntry,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SubscribeDeshredRequest_DeshredTransactionsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): SubscribeDeshredRequest_DeshredTransactionsEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
  ...
  toJSON(message: SubscribeDeshredRequest_DeshredTransactionsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create<I extends Exact<DeepPartial<SubscribeDeshredRequest_DeshredTransactionsEntry>, I>>(
    base?: I,
  ): SubscribeDeshredRequest_DeshredTransactionsEntry {
    return SubscribeDeshredRequest_DeshredTransactionsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SubscribeDeshredRequest_DeshredTransactionsEntry>, I>>(
    object: I,
  ): SubscribeDeshredRequest_DeshredTransactionsEntry {
    const message = createBaseSubscribeDeshredRequest_DeshredTransactionsEntry();
    message.key = object.key ?? "";
...
function createBaseSubscribeDeshredRequest_SlotsEntry(): SubscribeDeshredRequest_SlotsEntry {
  return { key: "", value: undefined };
}

export const SubscribeDeshredRequest_SlotsEntry: MessageFns<SubscribeDeshredRequest_SlotsEntry> = {
  encode(message: SubscribeDeshredRequest_SlotsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SubscribeDeshredRequest_SlotsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): SubscribeDeshredRequest_SlotsEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? SubscribeRequestFilterSlots.fromJSON(object.value) : undefined,
    };
  ...
  toJSON(message: SubscribeDeshredRequest_SlotsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create<I extends Exact<DeepPartial<SubscribeDeshredRequest_SlotsEntry>, I>>(
    base?: I,
  ): SubscribeDeshredRequest_SlotsEntry {
    return SubscribeDeshredRequest_SlotsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SubscribeDeshredRequest_SlotsEntry>, I>>(
    object: I,
  ): SubscribeDeshredRequest_SlotsEntry {
    const message = createBaseSubscribeDeshredRequest_SlotsEntry();
    message.key = object.key ?? "";
...
function createBaseSubscribeUpdateAccount(): SubscribeUpdateAccount {
  return { account: undefined, slot: 0n, isStartup: false, bankId: undefined };
}
...
export const SubscribeUpdateAccount: MessageFns<SubscribeUpdateAccount> = {
  encode(message: SubscribeUpdateAccount, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.bankId !== undefined) {
      ...
      writer.uint32(32).uint64(message.bankId);
    }
    return writer;
  },
  ...
  fromJSON(object: any): SubscribeUpdateAccount {
    return {
      ...
      isStartup: isSet(object.isStartup)
        ...
        : false,
      bankId: isSet(object.bankId) ? BigInt(object.bankId) : isSet(object.bank_id) ? BigInt(object.bank_id) : undefined,
    };
  },
  ...
  fromJSON(object: any): SubscribeUpdateAccountInfo {
    return {
      ...
      rentEpoch: isSet(object.rentEpoch)
        ? BigInt(object.rentEpoch)
        : isSet(object.rent_epoch)
        ? BigInt(object.rent_epoch)
        : 0n,
      data: isSet(object.data) ? bytesFromBase64(object.data) : new Uint8Array(0),
      writeVersion: isSet(object.writeVersion)
        ? BigInt(object.writeVersion)
        : isSet(object.write_version)
        ? BigInt(object.write_version)
        : 0n,
...
function createBaseSubscribeUpdateSlot(): SubscribeUpdateSlot {
  return { slot: 0n, parent: undefined, status: 0, deadError: undefined, bankId: undefined };
}
...
export const SubscribeUpdateSlot: MessageFns<SubscribeUpdateSlot> = {
  encode(message: SubscribeUpdateSlot, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.bankId !== undefined) {
      ...
      writer.uint32(40).uint64(message.bankId);
    }
    return writer;
  },
...
function createBaseSubscribeUpdateTransaction(): SubscribeUpdateTransaction {
  return { transaction: undefined, slot: 0n, bankId: 0n };
}
...
export const SubscribeUpdateTransaction: MessageFns<SubscribeUpdateTransaction> = {
  encode(message: SubscribeUpdateTransaction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.bankId !== 0n) {
      ...
      writer.uint32(24).uint64(message.bankId);
    }
    return writer;
  },
  ...
  fromJSON(object: any): SubscribeUpdateBlock {
    return {
      ...
      executedTransactionCount: isSet(object.executedTransactionCount)
        ...
        ? BigInt(object.executed_transaction_count)
        : 0n,
      ...
      updatedAccountCount: isSet(object.updatedAccountCount)
        ? BigInt(object.updatedAccountCount)
        : isSet(object.updated_account_count)
        ? BigInt(object.updated_account_count)
        : 0n,
      ...
      entriesCount: isSet(object.entriesCount)
        ? BigInt(object.entriesCount)
        : isSet(object.entries_count)
        ? BigInt(object.entries_count)
        : 0n,
...
export const SubscribeUpdateBlockMeta: MessageFns<SubscribeUpdateBlockMeta> = {
  encode(message: SubscribeUpdateBlockMeta, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.bankId !== 0n) {
      ...
      writer.uint32(80).uint64(message.bankId);
    }
    return writer;
  },
...
export const SubscribeUpdateEntry: MessageFns<SubscribeUpdateEntry> = {
  encode(message: SubscribeUpdateEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.bankId !== 0n) {
      ...
      writer.uint32(56).uint64(message.bankId);
    }
    return writer;
  },
  ...
  fromJSON(object: any): SubscribeUpdateEntry {
    return {
      ...
      numHashes: isSet(object.numHashes)
        ? BigInt(object.numHashes)
        : isSet(object.num_hashes)
        ? BigInt(object.num_hashes)
        : 0n,
      ...
      startingTransactionIndex: isSet(object.startingTransactionIndex)
        ? BigInt(object.startingTransactionIndex)
        : isSet(object.starting_transaction_index)
        ? BigInt(object.starting_transaction_index)
        : 0n,
      bankId: isSet(object.bankId) ? BigInt(object.bankId) : isSet(object.bank_id) ? BigInt(object.bank_id) : 0n,
    };
  },
...
function createBaseSubscribeUpdateDeshredTransaction(): SubscribeUpdateDeshredTransaction {
  return { transaction: undefined, slot: 0n };
}

export const SubscribeUpdateDeshredTransaction: MessageFns<SubscribeUpdateDeshredTransaction> = {
  encode(message: SubscribeUpdateDeshredTransaction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.transaction !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SubscribeUpdateDeshredTransaction {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): SubscribeUpdateDeshredTransaction {
    return {
  ...
  toJSON(message: SubscribeUpdateDeshredTransaction): unknown {
    const obj: any = {};
    if (message.transaction !== undefined) {
  ...
  create<I extends Exact<DeepPartial<SubscribeUpdateDeshredTransaction>, I>>(
    base?: I,
  ): SubscribeUpdateDeshredTransaction {
    return SubscribeUpdateDeshredTransaction.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SubscribeUpdateDeshredTransaction>, I>>(
    object: I,
  ): SubscribeUpdateDeshredTransaction {
    const message = createBaseSubscribeUpdateDeshredTransaction();
    message.transaction = (object.transaction !== undefined && object.transaction !== null)
...
function createBaseSubscribeUpdateDeshredTransactionInfo(): SubscribeUpdateDeshredTransactionInfo {
  return {
...
export const SubscribeUpdateDeshredTransactionInfo: MessageFns<SubscribeUpdateDeshredTransactionInfo> = {
  encode(message: SubscribeUpdateDeshredTransactionInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.signature.length !== 0) {
      writer.uint32(10).bytes(message.signature);
    }
    if (message.isVote !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SubscribeUpdateDeshredTransactionInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): SubscribeUpdateDeshredTransactionInfo {
    return {
      signature: isSet(object.signature) ? bytesFromBase64(object.signature) : new Uint8Array(0),
      isVote: isSet(object.isVote)
        ? globalThis.Boolean(object.isVote)
  ...
  toJSON(message: SubscribeUpdateDeshredTransactionInfo): unknown {
    const obj: any = {};
    if (message.signature.length !== 0) {
      obj.signature = base64FromBytes(message.signature);
    }
  ...
  create<I extends Exact<DeepPartial<SubscribeUpdateDeshredTransactionInfo>, I>>(
    base?: I,
  ): SubscribeUpdateDeshredTransactionInfo {
    return SubscribeUpdateDeshredTransactionInfo.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SubscribeUpdateDeshredTransactionInfo>, I>>(
    object: I,
  ): SubscribeUpdateDeshredTransactionInfo {
    const message = createBaseSubscribeUpdateDeshredTransactionInfo();
    message.signature = object.signature ?? new Uint8Array(0);
...
function createBaseSubscribeUpdateDeshred(): SubscribeUpdateDeshred {
  return {
    filters: [],
...
export const SubscribeUpdateDeshred: MessageFns<SubscribeUpdateDeshred> = {
  encode(message: SubscribeUpdateDeshred, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.filters) {
      writer.uint32(10).string(v!);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SubscribeUpdateDeshred {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): SubscribeUpdateDeshred {
    return {
      filters: globalThis.Array.isArray(object?.filters) ? object.filters.map((e: any) => globalThis.String(e)) : [],
  ...
  toJSON(message: SubscribeUpdateDeshred): unknown {
    const obj: any = {};
    if (message.filters?.length) {
      obj.filters = message.filters;
    }
  ...
  create<I extends Exact<DeepPartial<SubscribeUpdateDeshred>, I>>(base?: I): SubscribeUpdateDeshred {
    return SubscribeUpdateDeshred.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SubscribeUpdateDeshred>, I>>(object: I): SubscribeUpdateDeshred {
    const message = createBaseSubscribeUpdateDeshred();
    message.filters = object.filters?.map((e) => e) || [];
  ...
  fromJSON(object: any): SubscribeReplayInfoResponse {
    return {
      firstAvailable: isSet(object.firstAvailable)
        ? BigInt(object.firstAvailable)
        : isSet(object.first_available)
        ? BigInt(object.first_available)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): GetLatestBlockhashResponse {
    return {
      ...
      lastValidBlockHeight: isSet(object.lastValidBlockHeight)
        ? BigInt(object.lastValidBlockHeight)
        : isSet(object.last_valid_block_height)
        ? BigInt(object.last_valid_block_height)
        : 0n,
    };
  },
