...
exports.SubscribeRequest = {
    ...
    toJSON: function (message) {
        ...
        if (message.transactionsStatus) {
            var entries = Object.entries(message.transactionsStatus);
            if (entries.length > 0) {
...
exports.GeyserService = {
    ...
    subscribeReplayInfo: {
        ...
        requestSerialize: function (value) {
            return Buffer.from(exports.SubscribeReplayInfoRequest.encode(value).finish());
        },
        requestDeserialize: function (value) { return exports.SubscribeReplayInfoRequest.decode(value); },
        responseSerialize: function (value) {
            return Buffer.from(exports.SubscribeReplayInfoResponse.encode(value).finish());
        },
        responseDeserialize: function (value) { return exports.SubscribeReplayInfoResponse.decode(value); },
    },
    ping: {
