...
CommitmentOption = Union[Literal['processed'], Literal['confirmed'], Literal['finalized']]
...
class FumaroleClient:
    ...
    def list_available_commitments(
        self
    ) -> list[str]:
    ...
    def delete_consumer_group(
        ...
        resp = self.stub.DeleteConsumerGroup(
            fumarole_pb2.DeleteConsumerGroupRequest(
    ...
    def get_cg_info(
        self,
        name: str
    ) -> Optional[fumarole_pb2.ConsumerGroupInfo]:
        try:
            resp = self.stub.GetConsumerGroupInfo(
                fumarole_pb2.GetConsumerGroupInfoRequest(
                    consumer_group_label=name
                ),
                metadata=self.metadata
            )
    ...
    def list_consumer_groups(
        ...
        resp = self.stub.ListConsumerGroups(
            fumarole_pb2.ListConsumerGroupsRequest(),
            metadata=self.metadata
        )
    ...
    def create_consumer_group(
        ...
        if include == 'account':
            event_subscription_policy = fumarole_pb2.EventSubscriptionPolicy.ACCOUNT_UPDATE_ONLY
        elif include == 'tx':
            event_subscription_policy = fumarole_pb2.EventSubscriptionPolicy.TRANSACTION_ONLY
        else:
    ...
    def subscribe(
        ...
        member_idx: int = 0,
        mapper: Union[Literal['json'], Literal['summ'], Callable[[geyser_pb2.SubscribeUpdate], any]] = 'summ',
