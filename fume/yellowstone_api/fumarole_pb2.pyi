...
from yellowstone_api.geyser_pb2 import (
    SubscribeRequestFilterAccounts as SubscribeRequestFilterAccounts,
)
from yellowstone_api.geyser_pb2 import (
    SubscribeRequestFilterAccountsFilter as SubscribeRequestFilterAccountsFilter,
)
from yellowstone_api.geyser_pb2 import (
    SubscribeRequestFilterAccountsFilterMemcmp as SubscribeRequestFilterAccountsFilterMemcmp,
)
from yellowstone_api.geyser_pb2 import (
    SubscribeRequestFilterAccountsFilterLamports as SubscribeRequestFilterAccountsFilterLamports,
)
from yellowstone_api.geyser_pb2 import (
    SubscribeRequestFilterSlots as SubscribeRequestFilterSlots,
)
from yellowstone_api.geyser_pb2 import (
    SubscribeRequestFilterTransactions as SubscribeRequestFilterTransactions,
)
from yellowstone_api.geyser_pb2 import (
    SubscribeRequestFilterBlocks as SubscribeRequestFilterBlocks,
)
from yellowstone_api.geyser_pb2 import (
    SubscribeRequestFilterBlocksMeta as SubscribeRequestFilterBlocksMeta,
)
from yellowstone_api.geyser_pb2 import (
    SubscribeRequestFilterEntry as SubscribeRequestFilterEntry,
)
from yellowstone_api.geyser_pb2 import (
    SubscribeRequestAccountsDataSlice as SubscribeRequestAccountsDataSlice,
)
...
from yellowstone_api.geyser_pb2 import (
    SubscribeUpdateAccountInfo as SubscribeUpdateAccountInfo,
)
from yellowstone_api.geyser_pb2 import SubscribeUpdateSlot as SubscribeUpdateSlot
from yellowstone_api.geyser_pb2 import (
    SubscribeUpdateTransaction as SubscribeUpdateTransaction,
)
from yellowstone_api.geyser_pb2 import (
    SubscribeUpdateTransactionInfo as SubscribeUpdateTransactionInfo,
)
from yellowstone_api.geyser_pb2 import (
    SubscribeUpdateTransactionStatus as SubscribeUpdateTransactionStatus,
)
from yellowstone_api.geyser_pb2 import SubscribeUpdateBlock as SubscribeUpdateBlock
from yellowstone_api.geyser_pb2 import (
    SubscribeUpdateBlockMeta as SubscribeUpdateBlockMeta,
)
...
from yellowstone_api.geyser_pb2 import (
    GetLatestBlockhashRequest as GetLatestBlockhashRequest,
)
from yellowstone_api.geyser_pb2 import (
    GetLatestBlockhashResponse as GetLatestBlockhashResponse,
)
...
from yellowstone_api.geyser_pb2 import (
    IsBlockhashValidRequest as IsBlockhashValidRequest,
)
from yellowstone_api.geyser_pb2 import (
    IsBlockhashValidResponse as IsBlockhashValidResponse,
)
...
class ListAvailableCommitmentLevelsResponse(_message.Message):
    ...
    commitment_levels: _containers.RepeatedScalarFieldContainer[
        _geyser_pb2.CommitmentLevel
    ]
    def __init__(
        self,
        commitment_levels: _Optional[
            _Iterable[_Union[_geyser_pb2.CommitmentLevel, str]]
        ] = ...,
    ) -> None: ...
...
class ListConsumerGroupsResponse(_message.Message):
    ...
    def __init__(
        self,
        consumer_groups: _Optional[
            _Iterable[_Union[ConsumerGroupInfo, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class ConsumerGroupInfo(_message.Message):
    ...
    def __init__(
        self,
        id: _Optional[str] = ...,
        consumer_group_label: _Optional[str] = ...,
        consumer_group_type: _Optional[_Union[ConsumerGroupType, str]] = ...,
        member_count: _Optional[int] = ...,
        commitment_level: _Optional[_Union[_geyser_pb2.CommitmentLevel, str]] = ...,
        event_subscription_policy: _Optional[
            _Union[EventSubscriptionPolicy, str]
        ] = ...,
        is_stale: bool = ...,
    ) -> None: ...
...
class GetSlotLagInfoResponse(_message.Message):
    ...
    global_max_slot: int
    def __init__(
        self, max_slot_seen: _Optional[int] = ..., global_max_slot: _Optional[int] = ...
    ) -> None: ...
...
class SubscribeRequest(_message.Message):
    ...
    consumer_group_label: str
    consumer_id: int
    accounts: AccountUpdateFilter
    transactions: TransactionFilter
    def __init__(
        self,
        consumer_group_label: _Optional[str] = ...,
        consumer_id: _Optional[int] = ...,
        accounts: _Optional[_Union[AccountUpdateFilter, _Mapping]] = ...,
        transactions: _Optional[_Union[TransactionFilter, _Mapping]] = ...,
    ) -> None: ...
...
class CreateStaticConsumerGroupRequest(_message.Message):
    ...
    def __init__(
        ...
        consumer_group_label: _Optional[str] = ...,
        member_count: _Optional[int] = ...,
        initial_offset_policy: _Optional[_Union[InitialOffsetPolicy, str]] = ...,
        commitment_level: _Optional[_Union[_geyser_pb2.CommitmentLevel, str]] = ...,
        event_subscription_policy: _Optional[
            _Union[EventSubscriptionPolicy, str]
        ] = ...,
        at_slot: _Optional[int] = ...,
    ) -> None: ...

class AccountUpdateFilter(_message.Message):
    __slots__ = ("account", "owner")
...
class TransactionFilter(_message.Message):
    ...
    account_keys: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, account_keys: _Optional[_Iterable[str]] = ...) -> None: ...
