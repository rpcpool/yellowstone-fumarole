...
class SubscribeRequest(_message.Message):
    ...
    def __init__(self, consumer_group_label: _Optional[str] = ..., consumer_id: _Optional[int] = ..., accounts: _Optional[_Union[AccountUpdateFilter, _Mapping]] = ..., transactions: _Optional[_Union[TransactionFilter, _Mapping]] = ...) -> None: ...
...
class AccountUpdateFilter(_message.Message):
    ...
    def __init__(self, account: _Optional[_Iterable[str]] = ..., owner: _Optional[_Iterable[str]] = ...) -> None: ...
